...
((echo "$N1 $t_mul" && (sed '18q;d' mul.dat | awk '{print $9}') && (sed '18q;d' mul.dat | awk '{print $15}') && echo "$t_tras" && (sed '18q;d' tras.dat | awk '{print $9}') && (sed '18q;d' tras.dat | awk '{print $15}')) | echo $(cat $1)) | sed 's/,//g' >> mult.dat
...
gnuplot << EOF
    ...
    plot 'mult.dat' using 1:5 title 'trasp-time' with lines    
    replot
    quit
EOF
...
gnuplot << EOF
    ...
    plot 'mult.dat' using 1:4 title 'normal-write' with lines, \
    plot 'mult.dat' using 1:6 title 'trasp-read' with lines, \
    plot 'mult.dat' using 1:7 title 'trasp-write' with lines
    replot
    quit
EOF
